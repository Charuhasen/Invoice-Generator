...
#ifndef INVOICE_GENERATOR_SWIFT_H
#define INVOICE_GENERATOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="invoice_generator",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17invoice_generator11AppDelegate")
...
SWIFT_CLASS("_TtC17invoice_generator17MainFlutterWindow")
